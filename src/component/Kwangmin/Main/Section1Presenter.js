...
import image11 from '../../../img/MainPage/glohands_culture.png'
import './Section.scss'
const Section1Presenter = ({props, context}) => {
    return (
        <section class="section" id="1">
        <div id="sec2">
            <p class="sec_top">서로의 도움으로 함께 성장하는 글로핸즈</p><br />
            <div class="sec_img"><img class="sec2_img" src={image11} alt="section1_img"/></div>
            <div class="sec_div">
...
export default Section1Presenter;